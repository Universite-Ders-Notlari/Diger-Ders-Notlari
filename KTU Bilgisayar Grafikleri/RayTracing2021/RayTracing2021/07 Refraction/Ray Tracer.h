...
namespace RayTracer 
{
	...
	public ref class RayTracer : public System::Windows::Forms::Form
	{
		...
		private: System::Void Render_Click(System::Object^  sender, System::EventArgs^  e) 
		{
			...
			Triangle T29(Vertex(70, 50, 90), Vertex(0, -50, 90), Vertex(0, -50, 100), 0.3, 0.7, 0.0, 0.0, 0.0, 0.0, Color::Red, 0);  // ÇUBUK
			...
			// x-ekseninde 45 derece döndür
			// Önceki konumlar : P0(-8, 100, 0), P1(8, 100, 0), P2(8, 91, 0), P3(-8, 91, 0), 
