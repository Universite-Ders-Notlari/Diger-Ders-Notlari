...
void OnUpdate()
{
	...
	XMMATRIX mRotate30  = XMMatrixRotationY(XM_PI / 6);           // 30 CW
	XMMATRIX mRotate45  = XMMatrixRotationY(XM_PI / 4);           // 45 CW
	XMMATRIX mRotate60  = XMMatrixRotationY(XM_PI / 3);           // 60 CW
