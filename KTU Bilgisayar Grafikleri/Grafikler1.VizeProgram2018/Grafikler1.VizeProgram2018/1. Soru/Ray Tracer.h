...
namespace RayTracer 
{
	...
	public ref class RayTracer : public System::Windows::Forms::Form
	{
		...
		public:
			Bitmap myBitmap_1 = Bitmap::FromFile("Textures\\bayrak.jpg");
		...
		private: System::Void Render_Click(System::Object^  sender, System::EventArgs^  e) 
		{
			...
			// Zemin
			Triangle T3(  Vertex( 60, -25,    0),     Vertex(-60, -25,   0),     Vertex( 60, -25, 120),   0.3, 0.7, 0.0, 0.0, 0.0, 0.0, Color::White, 0);
			Triangle T4(  Vertex(-60, -25,  120),     Vertex( 60, -25, 120),     Vertex(-60, -25,   0),   0.3, 0.7, 0.0, 0.0, 0.0, 0.0, Color::White, 0); 
			...
			// Mona Lisa (Left Wall)
			Triangle T15(  Vertex(-59,  30,   75),     Vertex(-59,  30, 105),     Vertex(-59, -15,  75),   0.3, 0.7, 0.0, 0.0, 0.0, 0.0, Color::White, 0);
			Triangle T16(  Vertex(-59, -15,  105),     Vertex(-59, -15,  75),     Vertex(-59,  30, 105),   0.3, 0.7, 0.0, 0.0, 0.0, 0.0, Color::White, 0);
