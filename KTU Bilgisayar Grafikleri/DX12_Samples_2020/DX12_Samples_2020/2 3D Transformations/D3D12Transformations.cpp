//
//	DirectX12 > Transformations : Rotate, Translate, Scale	
//
...
void OnInit()
{
	...
	XMVECTOR Eye = XMVectorSet( 0.0f, 3.0f, -9.0f, 0.0f );
...
void OnUpdate()
{
	...
	//g_World = mTranslate * mScale * mRotate ; 
...
void OnRender()
{
	...
	// Set Cube1's Constant Buffer and Render
	m_commandList->SetGraphicsRootConstantBufferView(0, m_constantBuffer->GetGPUVirtualAddress());
	m_commandList->IASetVertexBuffers(0, 1, &m_vertexBufferView);
	m_commandList->IASetIndexBuffer(&m_indexBufferView);
	m_commandList->DrawIndexedInstanced(36, 1, 0, 0, 0);

	// Set Cube2's Constant Buffer and Render
...
HRESULT InitWindow(HINSTANCE hInstance, int nCmdShow)
{
	...
	wcex.lpszClassName = "D3D12Transformations";
	...
	m_hwnd = CreateWindow(
		"D3D12Transformations", "DirectX12 > Transformations : Rotate, Translate, Scale",
