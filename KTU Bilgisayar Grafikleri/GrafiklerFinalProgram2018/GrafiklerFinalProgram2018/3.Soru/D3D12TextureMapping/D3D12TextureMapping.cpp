...
void OnUpdate()
{
	...
	//2017-2018 Final Sorusu : Farklı olan hangisi?
	g_World = Scale * Rot30 * Trans * Scale * Rot60;		
	g_World = Rot30 * Scale * Trans * Rot60 * Scale;		
	g_World = Scale * Trans * Rot30 * Scale * Rot60;	// *		
	g_World = Rot30 * Scale * Trans * Scale * Rot60;		
	g_World = Scale * Rot30 * Trans * Rot60 * Scale;		
